...
var argv = require("yargs/yargs")(process.argv.slice(2))
  ...
  .command(
    "ps2ad",
    "Detect and resolve differences in PowerSchool to Active Directory"
  )
  .alias("c", "config")
  .alias("h", "help")
  .alias("v", "version")
  ...
  .option("algo", {
    description:
      "Determines what Algorithm or Method should be used during comparison",
    type: "string",
    demandOption: false,
  })
  .option("domain", {
  ...
  .option("cache_path", {
    description:
      "Specifies the folder location to use for the Application Cache Path",
    type: "string",
    demandOption: false,
  })
  .option("initial", {
  ...
  .option("ad_script_user_list", {
    description:
      "Define a custom file location to retreive a User List from AD",
    type: "string",
    demandOption: false,
    hidden: true,
  }).argv;
